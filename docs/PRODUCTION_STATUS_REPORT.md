...
### Learn Hub / Portal / Interview clarification (updated 2026-09-07)
...
| **Interview Masterclass** (`vlsi…/interview-masterclass`) | **Standalone one-time** ₹2,499 lifetime bank (~87 deep Q live; more domains Coming Soon) | SaaS Max / Learn Master tracks |
| **VLSI Studios** | Interactive SDC / Timing / MMMC / Power / Reports | Learn theory pages |
| **Portal packages** | Thesis / Inventor / Business **services** quotes | SaaS Max plan / Master tracks / Interview SKU |

Open depth items (empty interview domains, Synopsys Learn quiz thinness) live in `PRODUCT_STATUS_AND_LEFTOVERS.md` P2.13+.
