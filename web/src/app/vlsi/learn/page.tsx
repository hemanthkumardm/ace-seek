      ...
      >
        <div className="space-y-2 relative z-10">
          ...
          <p className="text-xs sm:text-sm max-w-xl leading-relaxed text-slate-200">
            280+ Staff/Principal problems across all 11 domains (DV/UVM, SDC, STA, PnR, UPF, CDC, DFT, RTL, IR Drop, Aptitude & Puzzles) with step-by-step math derivations and free previews. One-time ₹2,499 / $29 lifetime access.
          </p>
        </div>
