        ...
        <div className="sk-panel p-8 space-y-6 text-xs leading-relaxed text-slate-300">
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc list-inside space-y-1 text-slate-400 pl-2">
              ...
              <li><strong>Email Support:</strong> Send a request to <a href="mailto:support@ace-seek.com" className="text-[var(--accent-cyan)] underline">support@ace-seek.com</a> with your account email and Razorpay Payment ID.</li>
            </ul>
          </section>
