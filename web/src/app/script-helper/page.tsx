...
export default function ScriptHelper() {
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-8 bg-[#1a1a1a]">
      <div className="brutal-border bg-[#ffb6c1] border-4 p-8 max-w-2xl text-center space-y-6 brutal-shadow">
        ...
        <p className="text-sm font-mono bg-white p-4 brutal-border text-left">
          This tool will automate snippet generation for Tcl, Python, and Makefile workflows used in EDA/VLSI flows. Stop reinventing the wheel.
        </p>
