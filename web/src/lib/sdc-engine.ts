...
export const SDC_PRESETS: {
  ...
  {
    name: "Cadence Clock Mux & Physically Exclusive Domains",
    description:
      "Cadence Genus Common UI clock multiplexer model: dual generated clocks on shared output pin with physically exclusive group and downstream divide-by-2.",
    state: {
      primaryClocks: [
        {
          id: "clk_func",
          ...
          waveformRising: 0,
          waveformFalling: 1.0,
          targets: "[get_ports pad_clk_func]",
          isVirtual: false,
          uncertaintySetup: 0.05,
          uncertaintyHold: 0.02,
          latencySource: 0.1,
          latencyNetwork: 0.25,
        },
        {
          ...
          waveformRising: 0,
          waveformFalling: 5.0,
          targets: "[get_ports pad_clk_test]",
          isVirtual: false,
          uncertaintySetup: 0.15,
          uncertaintyHold: 0.08,
          latencySource: 0.2,
        ...
        },
        {
          ...
          targets: "",
          isVirtual: true,
          uncertaintySetup: 0.06,
          uncertaintyHold: 0.03,
          latencySource: 0,
          latencyNetwork: 0,
        },
      ],
      generatedClocks: [
        {
          id: "clk_mux_func",
          name: "clk_mux_func",
          masterClockId: "clk_func",
          sourcePin: "[get_ports pad_clk_func]",
          targets: "[get_pins u_clk_mux/Y]",
          divideBy: 1,
          multiplyBy: 1,
          invert: false,
        },
        {
          id: "clk_mux_test",
          name: "clk_mux_test",
          masterClockId: "clk_test",
          sourcePin: "[get_ports pad_clk_test]",
          targets: "[get_pins u_clk_mux/Y]",
          divideBy: 1,
          multiplyBy: 1,
          invert: false,
        },
        {
          id: "clk_div2_core",
          name: "clk_div2_core",
          masterClockId: "clk_mux_func",
          sourcePin: "[get_pins u_clk_mux/Y]",
          targets: "[get_pins u_clk_div2/q_reg/Q]",
          divideBy: 2,
          multiplyBy: 1,
          invert: false,
        },
      ...
      clockGroups: [
        {
          id: "cg_mux_excl",
          group1Clocks: ["clk_mux_func", "clk_div2_core"],
          group2Clocks: ["clk_mux_test"],
      ...
      multicycles: [
        {
          id: "mcp_func_div2",
          from: "[get_clocks clk_mux_func]",
          through: "",
          to: "[get_clocks clk_div2_core]",
          cycles: 2,
          type: "setup",
          edge: "end",
        },
      ...
      falsePaths: [
        {
          id: "fp_async_rst",
          from: "[get_ports pad_rst_n]",
          through: "",
          to: "",
          comment: "Asynchronous reset recovery/removal path",
        },
      ],
      pathDelays: [],
      caseAnalyses: [
        {
          id: "ca_test_mode",
          portOrPin: "[get_ports pad_test_mode]",
          value: "0",
        },
      ],
      disableTimings: [],
