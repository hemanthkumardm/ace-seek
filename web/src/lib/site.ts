...
export const PRICING: PricingTier[] = [
  {
    ...
    features: [
      "VLSI Learn Hub: Beginner & Standard tracks (Digital, STA, SDC, Tcl, PD)",
      "34 Live Production VLSI Engineering Calculators",
      "SDC Studio: Interactive constraint generator & waveforms",
      "Doc Compiler: Markdown → PDF / TeX / HTML",
      "Diff Studio: Side-by-side netlist and code comparison",
      "Format Studio: JSON ↔ YAML live convert",
      "25 converts / day · standard queue speed",
    ],
  },
  {
    id: "pro",
    ...
    price: "₹1,299",
    period: "/ month",
    blurb: "Daily driver for ASIC engineers: all interactive studios, expert curriculum, and full flow scripts.",
    cta: "Start Pro",
    ctaHref: "/signup?plan=pro",
    highlighted: true,
    features: [
      "Everything in Free",
      "All 6 VLSI Studios (Timing, MMMC, SDC, Reports & Tcl export)",
      "VLSI Learn Hub: Full Expert curriculum + RTL-to-GDSII Labs",
      "24/7 AI VLSI Tutor & Concept Assistant",
      "OpenROAD: Full flow script generator (OpenLane / SkyWater)",
      "Exact look PDF → DOCX (300 DPI) + Pro doc engine",
      "Diff Studio: Character highlight + .diff patch export",
      "Full format suite (TOML, CSV, Base64, Hex, URL)",
      "500 converts / day · Priority processing queue",
    ],
  },
  {
    id: "max",
    ...
    price: "₹2,499",
    period: "/ month",
    blurb: "Commercial power: all 3 Master EDA suites (Cadence, Synopsys, Open-Source) & Cloud ASIC runs.",
    cta: "Get Max",
    ctaHref: "/signup?plan=max",
    features: [
      "Everything in Pro",
      "Master Cadence EDA (Genus, Innovus, Voltus, Tempus, Conformal)",
      "Master Synopsys EDA (DC Ultra, ICC2, PrimePower, PrimeTime, Formality)",
      "Master Open-Source EDA (Yosys/ABC, OpenROAD, PSM, OpenSTA, Formal)",
      "Power Studio (UPF multi-voltage, level shifters, retention flops)",
      "OpenROAD Cloud Runner (Real Docker RTL → GDSII runs)",
      "Exact look PDF → DOCX up to 400 DPI",
      "Unlimited converts & max file size · Private vault",
    ],
  },
  {
    id: "team",
    ...
    price: "₹3,999",
    period: "/ seat / mo",
    blurb: "Enterprise ASIC teams: shared workspaces, seat delegation, central billing & SLA.",
    cta: "Get Team",
